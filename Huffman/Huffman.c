...
void destArrNodos(Nodo **, int); //Destruye un arreglo de nodos. No retorna nada pero deja vacía la lista de nodos.
...
void swap(Nodo *a, int i, int j); //Funcion auxiliar de quick. Invierte la posición de dos nodos en un arreglo.
